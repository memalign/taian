...
var l = {};
l['Call from US - 8:00AM to 9:00PM Eastern time: +1 (317)318-8258 (Chinese), +1 (317)318-8259 (English).  Call from China: 950-4044-2336 (Chinese, Beijing time  8:00pm-12:00am, no long distance charges). Email: <a href=\"mailto:chris@taianfinancial.com\">chris@taianfinancial.com</a>, <a href=\"mailto:taianfinancialllc@gmail.com\">taianfinancialllc@gmail.com</a>'] = "美国电话(美东时间8am-9pm): +1 (317)318-8258 (中文), +1 (317)318-8259 (英语)。 中国电话: 950-4044-2336 (中文, 北京时间 晚上8:00-12:00, 直接拨打, 无长途费)。 电子邮件：<a href=\"mailto:chris@taianfinancial.com\">chris@taianfinancial.com</a>, <a href=\"mailto:taianfinancialllc@gmail.com\">taianfinancialllc@gmail.com</a>";
l['Call from China: 950-4044-2336 (Chinese, Beijing time  8:00pm-12:00am, no long distance charges)'] = "中国电话: 950-4044-2336 (中文, 北京时间 晚上8:00-12:00, 直接拨打, 无长途费)";
l['Call from US - 8:00AM to 9:00PM Eastern time: +1 (317)318-8258 (Chinese), +1 (317)318-8259 (English)'] = "美国电话(美东时间8am-9pm): +1 (317)318-8258 (中文), +1 (317)318-8259 (英语)";
l['TaiAn International Health Insurance - IMG Endorsed Independent Chinese Sales Center'] = "美国泰安国际医疗保险 - IMG授权的独立中文销售中心";
...
l['1) Medical benefits of at least $100,000 per accident or illness'] = "1) Medical benefits of at least $100,000 per accident or illness (每次生病或受伤的最高赔付至少为$100,000)";
l['2) Repatriation of remains in the amount of $25,000'] = "2) Repatriation of remains in the amount of $25,000 (遗体返送$25,000)";
l['3) Expenses associated with the medical evacuation of the exchange visitor to his or her home country in the amount of $50,000'] = "3) Expenses associated with the medical evacuation of the exchange visitor to his or her home country in the amount of $50,000 (紧急救护$50,000)";
...
l['If you select a $100,000 benefit per illness or injury (or higher benefit) all the options in TaiAn Plan B meet USDOS requirements.  The insurer rating by A.M. Best is \"A\", and also meets the requirements.'] = "如果选择每次生病或受伤最高赔付$100,000(或更高)，所有计划B里的选项都符合国务院J签证保险的标准。 保险公司被A.M.Best公司评级为“A-”";
...
l['No, it doesn\'t. In the U.S., insurance that covers child physical exams and vaccines normally cost more than $200-$300 per month.  Contact us for ways to get inexpensive, and sometimes free, vaccines or immunizations, as well as child physical exams.'] = "不包括。在美国包括体检和疫苗的保险通常每月的保费至少$200-300。请咨询我们，我们会为你提供经济实惠甚至免费的去处。";
...
l['Business Address: D200 301 E Carmel Drive - Carmel, IN 46032 - USA'] = "公司地址: D200 301 E Carmel Drive - Carmel, IN 46032 - USA";
...
l['4) Payment is on the last page of application. You have to use one credit card (or debit card which has a Visa, MasterCard or American Express logo) to pay for the whole group. Please use the credit card holder\'s initials as the \"Sponsoring Organization\". Use the credit card holders name as the \"Contact Name\".  Use the credit card holder\'s email as the group contact for the plan. Billing Address is the address you used when you applied for your credit card. IMG will not bill to your billing address.'] = "4) 申请表的最后一页是付款，整个团体用同一张信用卡付款 (也可以用中国信用卡或印有Visa、MasterCard或American Express字样的借记卡)。请用信用卡持有人的姓名缩写作为 \"Sponsoring Organization\"，信用卡持有人姓名为\"Contact Name\"，用信用卡持有人的Email 作为保险公司联系团体的Email。 Billing address 是你信用卡开户时所用的地址。保险公司不会将账单寄到这个地址，要求填写Billing address是为了确认信用卡的正确性。 注意输入电子签名时需要与信用卡上的姓名一样。";
...
l['Buy Plan A Standard Student Health Advantage'] = "购买标准计划A Standard Student Health Advantage";
l['Buy Group A Standard (10% off) For 2 primary insured or more'] = "购买团体标准计划A(10%优惠）两个或以上主申请人";
l[' or '] = " 或 ";
l['Buy Plan A Platinum Student Health Advantage'] = "购买铂金计划A Platinum Student Health Advantage";
l['Buy Group A Platinum (10% off) For 2 primary insured or more'] = "购买团体铂金计划A(10%优惠）两个或以上主申请人";
l['Does the plan cover dental and vision?'] = "此保险包含牙科和眼科吗？";
l['For dental the plan covers injuries up to $500, and treatment for sudden pain up to $350.  For vision the plan covers injuries.  If you are looking for coverage for routine dental or vision exams, or if you already know you need dental work or glasses you should consider supplementing the medical plan with a Careington Dental and Vision Discount Plan.  This plan provides discounts on dental and vision treatments, and there are no waiting periods before you can get a discount.  You can buy today and get a discount on your dental cleaning, periodontics, major dental procedures, vision exams, or glasses as soon as you receive your membership kit. You can pay monthly and cancel anytime.'] = "此保险含有意外牙科和眼科，不含普通牙科和眼科。牙科受伤最高赔付$500，突发性疼痛$350。眼科包含意外受伤。如果你需要普通牙科或眼科但又不愿购买保险时，你可以考虑Careington Dental and Vision Discount Plan，这是在你自己出钱看牙科眼科时的折扣计划。该计划提供对牙齿和视力治疗的折扣，没有等待期，收到会员卡后即可使用。包括的内容很广，如洗牙、牙周病、口腔外科、验光配镜等等。可以按月缴费随时取消。";
l['You can search the network for providers around you and learn more about the discount details before purchase. For more information and to purchase click on:  '] = "请先查看你周围的网络医生，确认discount后再决定是否购买。详见: ";
l['Patriot Travel Questions and Answers'] = "Patriot Travel问答";
l['Who is eligible for Patriot Travel Insurance? What is the advantage of the plan?'] = "哪些人可以购买爱国者国际旅游医疗保险，此保险的优势是什么？";
l['Patriot Travel Medical Insurance is designed for anyone (U.S. and non-U.S. citizens) traveling out of their home country, regardless of visa requirements. Cost starts at about $1/day. Purchase from 5 days to 1 year, and renewable up to 2 years if 1 month or more is purchased initially.'] = "爱国者国际旅游医疗保险适用于任何人出国旅游任何国家。也适用于长期居住中国的美国宝宝。 保险可以按实际天数购买，最少5天，也可以按月购买。首次购买一个月或一个月以上，以后就可以续保至两年。比较经济实惠，每天$1起。";
l['How do I buy Patriot Travel Medical Insurance and how long will it take to receive the fulfillment?'] = "如何购买? 提交申请后需要多久可以收到保单？";
l['Buy Travel Insurance online and receive the fulfillment instantly. Purchase steps are as follows:'] = "网上购买，即刻收到Email电子保单。具体操作步骤如下：";
l['2) Read Patriot America benefits chart and brochure'] = "2) 阅读 \"中文填表指南\"";
l['Buy Patriot Travel Medical Insurance'] = "购买爱国者旅游医疗保险";
l['4) According to your needs, select a deductible and benefit maximum.'] = "4) 填表时，根据你自己的需要选择免赔额和最高赔付限额";
l['6) After you submit an application online successfully, you will receive an Email from IMG in a few minutes (If you do not receive it, please check your spam), which contains your insurance card and your confirmation letter (Visa Letter).  The confirmation letter can be used as proof of insurance.'] = "6) 网上成功提交申请几分钟后你就会收到Email电子保单(如果没有收到，请检查垃圾邮件)，其中含有保险卡(ID Card)和确认信(Visa Letter)。电子保单和确认信可以作为购买保险的证明。24小时之内你还会收到泰安的中文Email，其中有如何使用保险的说明。";
l['How do I buy Patriot Group Travel Medical Insurance to get 10% off?'] = "如何购买团体保险获得10%优惠?";
l['Patriot America Group plan is available for groups of 5 or more primary applicants (any visa types).'] = "五个或五个以上的主申请人(任何签证类型)可以组团购买团体旅游保险。每个主申请人和家属都享受10%的优惠。购买操作如下：";
l['2) Read Patriot America chart and brochure. Click on purchase link '] = "2) 阅读购买团体计划的“中文填表指南”, 点击购买链接: ";
l['Buy Group 10% off , Group for 5 or More'] = "购买团体计划(10%优惠)";
l['4) According to your group needs, select a deductible and benefit maximum.'] = "4) 根据团体成员的需要，选择免赔额和最高赔付限额。美国地址选择邮寄接收方式，中国地址选择Email接收方式 ";
l['Patriot America customers can go to any provider, but will receive more benefits in-PPO. In-PPO, after deductible, you pay co-insurance 10% up to $500. Out-PPO; after deductible, you co-insurance 20% up to $1000. Then plan pays 100% eligible charges.  If you need to go to a doctor in the United States, you need an appointment. For your own benefit, usually try to go to IMG\'s designated provider (doctor, hospital or urgent care center). You can search '] = "爱国者旅游医疗保险在指定医疗网络内就医能够得到更多的利益。在指定医疗网络就医，免赔额后，自付10%至$500；在非指定医疗网络就医，免赔额后，自付20%至$1000，然后保险赔付至最高赔付限额。在美国看病需要预约，登陆美国境内IMG";
l[' to find a medical provider.  When you see a doctor, carry your insurance card and personal ID (to verify your identity). In the United States if you do not have an appointment and go directly to the hospital, you go to the Emergency Room. If you go to the Emergency room and are not admitted to the hospital you have to pay a $250 additional deductible. In a real emergency situation (that is life-threatening or disabling), go to the nearest Emergency Room.  When you need urgent care and it is not an emergency, an Urgent Care center may be a good choice. They usually have evening and weekend hours and no appointment is necessary.'] = "PPO 网站，输入你的zip code，然后点击zip code 右边的 \"Go\", 你就可以查到你附近的网络内的医院医生，查到医生后即可预约看病。你还可以选择查找“医院”，“医生”，\"urgent care\" 或 \"specialists\"(专科)。若没有预约直接去医院则被认为需要去Emergency Room。如果不是受伤急诊或住院的生病急诊，就诊Emergency Room你就得付$250附加免赔额。在真正的紧急情况下(就是有生命危险或致残的情况下)，去Emergency Room就近应急。如果比较紧急但又不是Emergency, Urgent Care会比Emergency Room更合适。Urgent Care通常不需预约，且价格合理，利用上面的链接可以查找你附近的Urgent Care。";
l['What is the coinsurance for Patriot America plan?'] = "保险公司的赔付比例(coinsurance) ";
l['Patriot customers can go to any provider, but will receive more benefits in-PPO. In-PPO, after deductible you pay co-insurance of 10% up to $500. Out of the PPO, after the deductible you pay co-insurance of 20% up to $1000.  Then the plan pays 100% of eligible charges.'] = "对于理赔范围内的疾病和受伤，在指定医疗网络内就医能够得到更多的利益。在指定医疗网络就医，免赔额后自付10%至$500；在非指定医疗网络就医，免赔额后自付20%至$1000，然后保险赔付至最高赔付限额包括处方药。";
l['If the illness or injury is covered, the prescription medicine will be covered (subject to deductible and coinsurance) at 100% of usual charges until the maximum that you bought is met. When you need to fill a prescription you go to the preferred pharmacy with the prescription you received from the doctor. Make sure to bring the Universal URX Discount Card with you. You will have to pay for your prescription at the pharmacy but may receive a 10% to 50% discount with the card. You can then submit your receipts and a claim form to IMG for reimbursement.'] = "如果疾病或受伤是在理赔范围内，在你支付免赔额和共同保险之后，保险就会cover 100%此疾病的处方药直至你购买的最高赔付限额。去指定网络药店购买处方药，请显示Universal URX药品折扣卡，你可能得到10~50%的折扣。购买处方药你需要先垫付。然后将买药的收据和其他医疗费用收据与claim Form一起邮寄给IMG保险公司。";
l[''] = "";
l[''] = "";
l[''] = "";
l[''] = "";
