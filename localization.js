...
l['UC Riverside J scholars (not enrolled students) have required coverage as follows: 1. Medical benefits of $200,000 per accident or illness; 2. Repatriation of remains of $7,500; 3. Medical evacuation of $10,000; 4. Annual deductible not over $250. Taian Plan B (with $250,000 benefit and two deductible options) and Plan C (with $500,000 benefit and $250 deductible) are the most affordable plans that meet the school requirements and the USDOS requirements.  After submitting an application online successfully, you will receive an Email in a few minutes which contains your insurance ID card and your confirmation letter (Visa Letter). You can send the confirmation letter to your school as proof of insurance.'] = "UC Riverside 对J1访问学者(不包括全日制在校学生)购买校外医疗保险的要求是：1. 每次生病或受伤的最高赔付至少为$200,000;  2. 遗体返送$7,500;  3. 紧急救护$10,000;  4. 年度免赔额不超过$250。泰安保险计划B里的每次生病或受伤$250,000最高赔付(配合两种不同免赔额选项)和计划C ($500,000最高赔付, $250免赔额)都是满足此标准和国务院标准的最经济实惠的保险计划。网上提交申请几分钟后你就会收到Email电子保单，其中含有保险卡(ID Card)和确认信(Visa Letter)。将确认信发给学校证明你已购买满足学校要求的保险。";
