...
l['TaiAn Health Insurance for University of North Carolina - (Chapel Hill, Charlotte, Greensboro, Wilmington)'] = "泰安国际医疗保险 - University of North Carolina - (Chapel Hill, Charlotte, Greensboro, Wilmington)";
...
l['Taian Patriot Exchange Group plan available for groups of 2 or more primary applicants. Use one credit card to pay for the whole group. Use the credit card holder\'s email as the the group contact for the plan.'] = "两个或两个以上的主申请人购买泰安团体计划B享受10%的优惠。 整个团体用同一张信用卡付款，用信用卡持有人的Email 作为保险公司联系团体的Email";
