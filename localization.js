...
var l = {};
l['Organizations'] = "";
l['We work with representatives of International organizations, student or scholar organizations, and travel clubs to help your membership with their travel insurance needs.'] = "";
l['Global Application'] = "";
l['Spouse\'s Date of Birth'] = "配偶的出生日期 (如果配偶不买保险，此处留空）";
l['Spouse\'s Gender'] = "配偶的性别";
l['Number of Dependent Children Age 9 years or below'] = "子女数(如果子女不买保险，此处留空）年龄9岁或以下";
l['Number of Dependent Children Ages 10 to 18'] = "子女数(如果子女不买保险，此处留空）年龄10到18中";
...
l['Primary Insured-First Name'] = "主申请人名字";
l['Primary Insured-Last Name'] = "主申请人姓";
l['Primary Insured-Gender'] = "主申请人的性别";
l['Primary Insured-Date of Birth'] = "主申请人的出生日期";
l['Primary Insured-Height'] = "主申请人身高";
l['Primary Insured-Inches or centimeters'] = "主申请人英寸或厘米";
l['Primary Insured-Weight'] = "主申请人体重";
l['Primary Insured-Kilograms or Pounds'] = "主申请人公斤或磅";
l['Primary Insured-Occupation (ok to leave blank)'] = "主申请人职业（可以留空）";
l['Primary Insured-Government Issued ID Number'] = "主申请人政府颁发的身份证号码或护照号码";
l['Primary Insured-Country of Citizenship'] = "主申请人公民国家";
l['Primary Insured-If US Citizen Date you did or will depart US'] = "主申请人如果是美国公民，你离开美国的日期";
l['Primary Insured-Is your expected length of residence outside the U.S. at least 6 of the next 12 months? '] = "主申请人您计划在未来12个月里居住在美国境外至少6个月吗？";
l['Spouse-First Name'] = "";
l['Spouse-Last Name'] = "";
l['Spouse-Gender'] = "";
l['Spouse-Date of Birth'] = "";
l['Spouse-Height'] = "";
l['Spouse-Inches or centimeters'] = "";
l['Spouse-Weight'] = "";
l['Spouse-Kilograms or Pounds'] = "";
l['Spouse-Occupation (ok to leave blank)'] = "";
l['Spouse-Government Issued ID Number'] = "";
l['Spouse-Country of Citizenship'] = "";
l['Spouse-If US Citizen Date you did or will depart US'] = "";
l['Spouse-Is your expected length of residence outside the U.S. at least 6 of the next 12 months? '] = "";
l['Child 1-First Name'] = "";
l['Child 1-Last Name'] = "";
l['Child 1-Gender'] = "";
l['Child 1-Date of Birth'] = "";
l['Child 1-Height'] = "";
l['Child 1-Inches or centimeters'] = "";
l['Child 1-Weight'] = "";
l['Child 1-Kilograms or Pounds'] = "";
l['Child 1-Occupation (ok to leave blank)'] = "";
l['Child 1-Government Issued ID Number'] = "";
l['Child 1-Country of Citizenship'] = "";
l['Child 1-If US Citizen Date you did or will depart US'] = "";
l['Child 1-Is your expected length of residence outside the U.S. at least 6 of the next 12 months? '] = "";
l['Child 2-First Name'] = "";
l['Child 2-Last Name'] = "";
l['Child 2-Gender'] = "";
l['Child 2-Date of Birth'] = "";
l['Child 2-Height'] = "";
l['Child 2-Inches or centimeters'] = "";
l['Child 2-Weight'] = "";
l['Child 2-Kilograms or Pounds'] = "";
l['Child 2-Occupation (ok to leave blank)'] = "";
l['Child 2-Government Issued ID Number'] = "";
l['Child 2-Country of Citizenship'] = "";
l['Child 2-If US Citizen Date you did or will depart US'] = "";
l['Child 2-Is your expected length of residence outside the U.S. at least 6 of the next 12 months? '] = "";
l['Requested Coverage Effective Date'] = "";
l['Residence Address  (Best to use Chinese address)'] = "";
l['City'] = "";
l['County/Region'] = "";
l['State/Province (US or Canada only)'] = "";
l['Zip Code'] = "";
l['Country'] = "";
l['Telephone'] = "";
l['Email Address'] = "";
l['Forwarding Address  (Best to use US address)'] = "";
l['Are you or any other applicant currently disabled or unable to perform normal activities?(Indicate No or Identify P for Primary, S for Spouse, C1 for child 1, C2 for child 2)'] = "";
l['Are you or any other applicant presently hospitalized, or scheduled for or in need of hospitalization or surgery?(Indicate No or Identify P for Primary, S for Spouse, C1 for child 1, C2 for child 2)'] = "";
l['Have you or any other applicant ever tested positive for, been diagnosed with, or been treated for Acquired Immune Deficiency Syndrome (AIDS), AIDS Related Complex (ARC), Lymphadenopathy Syndrome, Human Immunodeficiency Virus (HIV) or any other Immune System Disorder?(Indicate No or Identify P for Primary, S for Spouse, C1 for child 1, C2 for child 2)'] = "";
l['Have you or any other applicant ever had, been recommended to have, or are you currently on a waiting list for any organ transplant (other than corneal)?(Indicate No or Identify P for Primary, S for Spouse, C1 for child 1, C2 for child 2)'] = "";
l['Do you participate in professional sports?(Indicate No or Identify P for Primary, S for Spouse, C1 for child 1, C2 for child 2)'] = "";
l['Have you or any other applicant been diagnosed with or treated for any type of cancer or pre-cancerous condition during the past five (5) years?(Indicate No or Identify P for Primary, S for Spouse, C1 for child 1, C2 for child 2)'] = "";
l['If a non-U.S. citizen, do you or any other applicant have a U.S. visa or green card?(Indicate No or Identify P for Primary, S for Spouse, C1 for child 1, C2 for child 2)'] = "";
l['If a non-U.S. citizen, have you or any other applicant resided continuously in the U.S. for the last five (5) years?(Indicate No or Identify P for Primary, S for Spouse, C1 for child 1, C2 for child 2)'] = "";
l['Are you or any other applicant currently pregnant?(Indicate No or Identify P for Primary, S for Spouse, C1 for child 1, C2 for child 2)'] = "";
...
l['Blood, blood vessels, spleen, arteries, veins or disorders of the blood, including, but not limited to: anemia, hemophilia, leukemia, hepatitis, lymph glands, or high cholesterol?(Indicate No or Identify P for Primary, S for Spouse, C1 for child 1, C2 for child 2)'] = "";
l['Diabetes, hyperglycemia or hypoglycemia?(Indicate No or Identify P for Primary, S for Spouse, C1 for child 1, C2 for child 2)'] = "";
l['Asthma or allergies?(Indicate No or Identify P for Primary, S for Spouse, C1 for child 1, C2 for child 2)'] = "";
l['Cancer, tumor, cyst, polyp, melanoma, Kaposi\'s sarcoma, cell disorder, shingles, lump, calcification, or growth of any kind?(Indicate No or Identify P for Primary, S for Spouse, C1 for child 1, C2 for child 2)'] = "";
l['Liver, Pancreas, Gall Bladder or endocrine disorders including, but not limited to: pituitary, thyroid or metabolic disorders, or obesity?(Indicate No or Identify P for Primary, S for Spouse, C1 for child 1, C2 for child 2)'] = "";
l['Kidney, urinary tract functions, kidney or bladder stones or infections?(Indicate No or Identify P for Primary, S for Spouse, C1 for child 1, C2 for child 2)'] = "";
l['Respiratory system including, but not limited to: tuberculosis, lung disorders, emphysema, chronic cough, bronchitis, bronchial asthma, pleurisy pneumonia?(Indicate No or Identify P for Primary, S for Spouse, C1 for child 1, C2 for child 2)'] = "";
...
l['Neurological disorders, including but not limited to: multiple sclerosis (MS), muscular dystrophy, Lou Gehrig\'s disease (ALS), Parkinson\'s disease, paralysis, epilepsy, convulsions, seizures, migraines, chronic headaches, stroke, or transient cerebral ischemic attacks?(Indicate No or Identify P for Primary, S for Spouse, C1 for child 1, C2 for child 2)'] = "";
...
l['For male applicants, disorders of the reproductive systems, including but not limited to: prostate or elevated PSA level, or erectile dysfunction?(Indicate No or Identify P for Primary, S for Spouse, C1 for child 1, C2 for child 2)'] = "";
l['Congenital, genetic, hereditary or other birth condition or defect including, but not limited to: mental retardation, Down Syndrome, or other chromosome disorder, physical disorder, deformity or defect?(Indicate No or Identify P for Primary, S for Spouse, C1 for child 1, C2 for child 2)'] = "";
l['Digestive system, stomach, or intestines, including, but not limited to: esophageal regurgitation, gastritis, ulcers, colon, or rectum disorders?(Indicate No or Identify P for Primary, S for Spouse, C1 for child 1, C2 for child 2)'] = "";
l['Eyes, ears, nose, mouth, throat or jaw, including, but not limited to: cataracts, glaucoma, nasal septum deviation, chronic sinusitis, or TMJ?(Indicate No or Identify P for Primary, S for Spouse, C1 for child 1, C2 for child 2)'] = "";
l['Any other disease, medical problem, illness, injury or condition of any kind not listed?(Indicate No or Identify P for Primary, S for Spouse, C1 for child 1, C2 for child 2)'] = "";
l['Do you or any family member applying for coverage currently use or during the past five years have you used tobacco in any form?(Indicate No or Identify P for Primary, S for Spouse, C1 for child 1, C2 for child 2)'] = "";
l['Have you or any family member applying for coverage ever applied or purchased insurance through IMG?(Indicate No or Identify P for Primary, S for Spouse, C1 for child 1, C2 for child 2)'] = "";
...
l['Have you or any family member applying for coverage ever been rejected, cancelled, rated or declined for coverage under any health, life or disability insurance policy?(Indicate No or Identify P for Primary, S for Spouse, C1 for child 1, C2 for child 2)'] = "";
l['During the last twelve (12) months, have you or any family member applying for coverage been covered under any health or medical insurance plan, including a government sponsored health care plan? If yes, please state the name and location of the insurance company, the policy/plan number, and the applicable dates of coverage.(Indicate No or Identify P for Primary, S for Spouse, C1 for child 1, C2 for child 2)'] = "";
l['Please provide details on any yes answer including doctor name and address, date last seen, details of the condition'] = "";
l['Primary Insured Family doctor Name'] = "";
l['Primary Insured Family doctor Address'] = "";
l['Primary Insured Family doctor City'] = "";
l['Primary Insured Family doctor State/Province (If in US)'] = "";
l['Primary Insured Family doctor Zip/Postal Code'] = "";
l['Primary Insured Family doctor Country'] = "";
l['Primary Insured Family doctor Telephone'] = "";
l['Primary Insured Family doctor Date Last Seen'] = "";
l['Primary Insured Family doctor Reason'] = "";
l['Spouse Family doctor Name'] = "";
l['Spouse Family doctor Address'] = "";
l['Spouse Family doctor City'] = "";
l['Spouse Family doctor State/Province (If in US)'] = "";
l['Spouse Family doctor Zip/Postal Code'] = "";
l['Spouse Family doctor Country'] = "";
l['Spouse Family doctor Telephone'] = "";
l['Spouse Family doctor Date Last Seen'] = "";
l['Spouse Family doctor Reason'] = "";
l['Child 1 Family doctor Name'] = "";
l['Child 1 Family doctor Address'] = "";
l['Child 1 Family doctor City'] = "";
l['Child 1 Family doctor State/Province (If in US)'] = "";
l['Child 1 Family doctor Zip/Postal Code'] = "";
l['Child 1 Family doctor Country'] = "";
l['Child 1 Family doctor Telephone'] = "";
l['Child 1 Family doctor Date Last Seen'] = "";
l['Child 1 Family doctor Reason'] = "";
l['Child 2 Family doctor Name'] = "";
l['Child 2 Family doctor Address'] = "";
l['Child 2 Family doctor City'] = "";
l['Child 2 Family doctor State/Province (If in US)'] = "";
l['Child 2 Family doctor Zip/Postal Code'] = "";
l['Child 2 Family doctor Country'] = "";
l['Child 2 Family doctor Telephone'] = "";
l['Child 2 Family doctor Date Last Seen'] = "";
l['Child 2 Family doctor Reason'] = "";
l['Partnerships'] = "合作";
l['Teachers'] = "教师";
