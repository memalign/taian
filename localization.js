...
l['Enrolled international students are allowed to waive only if they are an exchange student visiting through an official exchange program.  They are required to carry $250,000 per illness or injury and complete a waiver. Taian Scholar/Student Insurance Plan B with $250,000 benefit per illness or injury is the most affordable plan that meets the standards.'] = "只有是exchange program 的国际学生才能waive学校保险，其他全日制在校国际学生不能waive学校保险。waive学校保险要求含有$200,000 per illness or injury。 泰安访问学者/留学生保险计划B Standard Plan 里的$250,000 per illness or injury 是满足此标准的最经济实惠的保险计划。 购买成功后，需要将保险确认信和waiver form 一起发给学校, 要求waive 学校保险。";
